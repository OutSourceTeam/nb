    ...
    function changeSwiperBigImg(data,imgpath,popebigBannerSwiper){
        ...
        if (data.colorImgList) {
            $.each(data.colorImgList, function (n, item) {
                ...
                // var newSlide = popebigBannerSwiper.createSlide('<div style="background-size: cover;background-position: center center;background-repeat: no-repeat;width:100%;height:100%;background-image:url('+imgpath + item.img+')"/>','swiper-slide','div');
